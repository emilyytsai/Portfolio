...
<!-- home -->
  <section id="home" class="card mt-28 mx-auto w-full max-w-full sm:max-w-md lg:max-w-lg px-0 sm:px-0 sm:px-0 z-20 rounded-2xl
    ...
    <h2 class="text-4xl md:text-5xl font-bold text-center flex items-center justify-center gap-2 flex-wrap">
      <span class="text-sm md:text-xl">₊˚⊹</span> Hello&nbsp;<img src="https://github.com/user-attachments/assets/2b86e697-a3c6-4460-88d1-86d4a4711225" width="45" height="45" alt="spinning globe" class="inline-block align-middle"/>, &nbsp&nbspI'm Emi! <span class="text-sm md:text-2xl">⊹˚₊</span>
    </h2>
