<script lang="ts">
  ...
  export let colorStops: string[] = ['#000000', '#000000', '#000000'];
  export let amplitude = 1.0;
  export let blend = 0.5;
  export let speed = 1.0;
  export let fadeDuration = 1.0;
  ...
  onMount(() => {
    ...
    function animate(t: number) {
      ...
      program.uniforms.uColorStops.value = colorStops.map(hex => hexToRGBArray(hex));
...
<div bind:this={container} class="aurora-container" class:visible={loaded}></div>
